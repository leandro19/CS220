...
#define BUFSIZE 100
	...
	switch(dtype) {
		...
		case(int_type): printf("%d",*(int*)address); break;
		case(long_type): printf("%ld",*(long*)address); break;
		case(addr_type): printf("%p",*(long*)address); break;
		case(char_type): printf("%c",*(char*)address); break;
	}
}
